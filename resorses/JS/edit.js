...
document.addEventListener('click', (e) => {
    if (e.target.classList.contains(selectors.link)) {
        ...
        console.log(index);
        const urlToMerge = "https://github.com/lipovanton1001/MiT-21-Anton-Lipovetskyi-";
        console.log
...
document.querySelector(selectors.home).addEventListener('click', () => {
    window.location.href = "https://github.com/lipovanton1001/MiT-21-Anton-Lipovetskyi-";
})
